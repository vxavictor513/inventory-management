...
export default {
  ...
  setup() {
    ...
    // Computed summary stats (replaces calculateSummaryStats + data properties)
    ...
    // Pre-computed max revenue for O(1) bar height calculations
    ...
    // Format YYYY-MM string using i18n month keys so names translate correctly
    ...
    // Uses pre-computed maxRevenue to avoid O(n) scan per bar
